<%@ Page Title="" Language="C#" MasterPageFile="~/plantilla.Master" AutoEventWireup="true" CodeBehind="capObra.aspx.cs" Inherits="seguimientoObras.capObra" %>
                        ...
                        <div class="col-lg-9 col-lg-offset-1">
                            <fieldset>
                                ...
                                <div class="form-group">
                                    ...
                                    <div class="col-lg-9">
                                        <asp:FileUpload ID="fuFile" CssClass="form-control" runat="server" />
                                    </div>
                                </div>
                                <div class="form-group">
